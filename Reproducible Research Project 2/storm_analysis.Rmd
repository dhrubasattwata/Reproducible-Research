...
###  Tornadoes followed by excessive heat are the most dangerous event wrt to population health. On the economic front flash floods and thunderstorm wreck havoc. Crops are majorly damaged by drought, flood, hails.
...
### The number of casualties are aggregated event wise.
...
### Tornadoes, Excessive Heat and Flash Floods are the most dangerous events.
